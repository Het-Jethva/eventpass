...
- Make expiration correctness independent of schedulers. Evaluate deadlines during reads and mutations, run idempotent reconciliation during relevant traffic and dashboard activity, and use the Vercel Hobby daily job only for cleanup.
