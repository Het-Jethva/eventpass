 ...
 * is the sRGB conversion of `--foreground`, and the family asks for Inter
 * first so a client that happens to have it renders in the product's own
 * voice before falling back to the reader's system sans.
 *
